        ...
        <div class="p-6">
            ...
            <?php echo '<form method="post" action="'.BASE_URL.'/usuarios/editById/'.$datosUsuario['id'].'" class="space-y-4 ">'; ?>
                <div>
                    ...
                    <label >Nombre</label> 
                    <input  type="text" name="name" id="message-subject" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border" value="<?php echo $datosUsuario['name']; ?>">
                </div>
                <div>
                    <label>Apellido</label> 
                    <input  type="text" name="lastName" id="message-subject" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border" value="<?php echo $datosUsuario['lastName']; ?>">
                </div>
                <div>
                    <label>username</label> 
                    <input type="text" name="username" id="message-subject" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border" value="<?php echo $datosUsuario['username']; ?>">
                </div>
                <div>
                    <label>Contraseña</label> 
                    <input type="text" name="password" id="message-subject" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border" value="<?php echo $datosUsuario['password']; ?>">
                </div>
                <div>
                    <label>Correo electronico</label> 
                    <input type="text" name="email" id="message-subject" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border" value="<?php echo $datosUsuario['email']; ?>">
                </div>
                <div>
                ...
                <div class="pt-2 flex items center justify-center">
                    <button type="submit" class="text-center flex-1 bg-pink-600 hover:bg-pink-700 text-white py-2.5 px-4 rounded-md font-semibold shadow hover:shadow-md transition">Editar</button>
                    
                    <a href=<?php echo '"'.BASE_URL.'/usuarios/index"' ?> class="text-center flex-12 text-sm bg-gray-400 hover:bg-gray-500 text-white px-4 py-2.5 rounded-md transition shadow hover:shadow-md">REGRESAR</a>
                </div>
            </form>
        </div>
    </div>
