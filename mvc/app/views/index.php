                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href=<?php echo '"' . BASE_URL . '/tareas/index"' ?>php  class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-white/5 hover:text-white">Tareas</a>
                            <?php if ($userSesion['isAdmin'] == true) { ?>
                                <a href=<?php echo '"' . BASE_URL . '/usuarios/index"' ?>php class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-white/5 hover:text-white">Usuarios</a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                <?php echo "Bienvenido: ". $userSesion['name'] . " " . $userSesion['lastName']; ?>
