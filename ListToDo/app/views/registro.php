...
<body>
    <div class="bg-white rounded-lg shadow-xl max-w-lg w-full m-10">
        ...
        <form method='post' action="?action=nuevoRegistro">
            <label  >Usuario (correo)</label> <input name="username" type="text" required  placeholder="Correo electronico" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border">
            <br>
            ...
            <br>
            <label  >Apellido</label> <input name="apellido" type="text" required  placeholder="Apellido" class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500 p-2 border">
            <br>
