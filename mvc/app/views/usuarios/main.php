 ...
 <h2 class="text-3xl font-bold text-gray-900 m-10"><?php echo $userSesion['name']." ".$userSesion['lastName']; ?></h2>
            ...
            <div class="profile-card bg-stone-100 rounded-lg shadow-md overflow-hidden transition duration-300 flex flex-col">
                ...
                <div class="p-4 flex-grow flex flex-col justify-between">
                    ...
                    <div class="mt-4 flex gap-2">
                        ...
                        <a href=<?php echo '"'.BASE_URL.'/usuarios/deleteById/'. $elemento['id'].'"' ?> class="flex-1 text-sm bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-md transition shadow hover:shadow-md text-center"> Eliminar</a>
                        
                         

                         <a href=<?php echo '"'.BASE_URL.'/usuarios/viewUsuario/'. $elemento['id'].'"' ?> class="text-center flex-1 text-sm border border-red-600 text-red-600 hover:bg-red-50 px-3 py-2 rounded-md transition"> Ver</a>
    ...
    <br>
    <a href=<?php echo '"' . BASE_URL . '/usuarios/newUsuario"' ?> class="flex-1 text-sm bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-md transition shadow hover:shadow-md ml-10">Nuevo usuario</a>
    <button onclick="abrirModal()" type="button" data-toggle="modal" data-target="#verTodo" class="flex-1 text-sm bg-red-600/80 hover:bg-red-700/80 text-white px-3 py-2 rounded-md transition shadow hover:shadow-md ">Ver Todo</button>
